...
const privateKey = fs.readFileSync('YOUR SSL KEY').toString()
const certificate = fs.readFileSync('YOUR SSL CERT').toString()
const ca = fs.readFileSync('YOUR SSL CA').toString()

const socket = require('socket.io').listen(SERVER_PORT, {key: privateKey, cert: certificate, ca: ca})
